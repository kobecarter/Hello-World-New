...
<section>
  ...
  <!--========================================================
                          ABOUT
  =========================================================-->
  <section class="page-template pb-0 ">
          <div class="container about-us-new">
            ...
            <div class="row row-content">
                ...
                <div class="col-sm-12 col-md-5 offset-1">
                    <div class="about-us-imgbox">
                        <img class="offset-not-img" src="https://www.helloworld-agency.com/images/marketing_agency_marrakech1.webp">
                        <div class="about-us-video">
                            <a href="javascript:void(0)" class="video-circle" data-src="https://www.youtube.com/watch?v=iEY4FPau35Y" data-fancybox=""><i class="fab fa-youtube"></i></a>
                        </div>
  ...
  <section class="offices-section pb-5">
    <div class="container">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                   <div class="office-col">
                    <div class="office-col-content">
                        <h2 class="office-title"><a href="https://www.helloworldlabel.ae">Dubai</a></h2>
                    </div>
                   ...
                   <div class="office-col">
                    <div class="office-col-content">
                        <?php
                			...
                			?>
                        <h2 class="office-title"><a href="<?php echo $londonPage->getLink(); ?>">London</a></h2>
                    </div>
                    <div class="office-col-icons">
                        <ul>
                            <li><i class="fa fa-phone"></i>
                   ...
                   <div class="office-col">
                    <div class="office-col-content">
                        <?php
                			...
                			?>
                        <h2 class="office-title"><a href="<?php echo $marrakechPage->getLink(); ?>">Marrakech</a></h2>
                    </div>
                    <div class="office-col-icons">
                        <ul>
                            <li><i class="fa fa-phone"></i>
                ...
                <div class="col-sm-12 col-md-6 col-lg-6">
                   <div class="office-col">
                    <div class="office-col-content">
                			...
                			?>
	                         <h2 class="office-title"><a href="<?php echo $casaPage->getLink(); ?>">Casablanca</a></h2>
                    </div>
                    <div class="office-col-icons">
                        <ul>
                            <li><i class="fa fa-phone"></i>
  ...
  <!-- Start Team Section -->
<section class="mt-3 mt-sm-4 mb-4">
    <div class="container">
        <div class="row">
            <div class="col-12">
        ...
        <div class="cs-slider cs-style2 cs-gap-24">
            ...
            <div class="cs-slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
                ...
                <div class="cs-slider_wrapper">
                    ...
                    <!--  <div class="cs-team cs-style1">-->
                    <!--    <div class="cs-member_thumb">-->
                    <!--      <img src="<?php echo $siteURL; ?>images/team/khadija.jpeg" alt="Khadija">-->
                    <!--      <div class="cs-member_overlay"></div>-->
                    <!--    </div>-->
                    <!--    <div class="cs-member_info">-->
                    <!--      <h2 class="cs-member_name">-->
                    <!--        <a href="team-details.html">Khadija</a>-->
                    <!--      </h2>-->
