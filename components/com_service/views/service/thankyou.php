...
<section class="ty-hero">
  ...
  <div class="container">
    <div class="ty-hero-bread rv">
      <a href="<?php echo $siteURL; ?>"><?php echo $lang['BREADCRUMB_HOME'][$_SESSION['lang']]; ?></a>
      <i class="fa fa-chevron-right"></i>
      <a href="<?php echo $page->getLink(); ?>"><?php echo $page->getTitre(); ?></a>
      <i class="fa fa-chevron-right"></i>
      <span><?php echo $service->getTitre(); ?></span>
    </div>
    <div class="ty-hero-inner">
      <div>
        <div class="ty-hero-label rv"><?php echo $lang['CT_CONFIRM_LABEL'][$_SESSION['lang']]; ?></div>
        <h1 class="ty-hero-title rv d1"><?php echo $lang['SVC_THANKYOU_TITLE'][$_SESSION['lang']]; ?></h1>
        <p class="ty-hero-sub rv d2"><?php echo $lang['SVC_THANKYOU_MESSAGE'][$_SESSION['lang']]; ?></p>
        <div class="wm-hero-ctas rv d2">
            <a href="<?php echo $siteURL; ?>" class="sb sb-compact" role="slider" tabindex="0" aria-label="<?php echo $lang['CT_CONFIRM_BTN_HOME'][$_SESSION['lang']]; ?>" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0">
...
<section class="cta-band">
  <div class="container">
    ...
    <div class="cta-btns">
      ...
      <a href="<?php echo $service->getLink() ?>" class="sb sb-compact sb-invert" data-auto-reset="true" role="slider" tabindex="0" aria-label="<?php echo $lang['CT_CONFIRM_CTA_SEND_ARIA'][$_SESSION['lang']]; ?>" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0">
