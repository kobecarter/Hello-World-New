...
<section class="aia-hero">
    <div class="aia-hero-bg">
        <div class="aia-hero-grid">
            <svg viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <pattern id="aia-g" width="60" height="60" patternUnits="userSpaceOnUse">
                        <path d="M 60 0 L 0 0 0 60" fill="none" stroke="#8b6a22" stroke-width="0.5"/>
                    </pattern>
                </defs>
                <rect width="1440" height="900" fill="url(#aia-g)"/>
                <line x1="0" y1="900" x2="1440" y2="0" stroke="#8b6a22" stroke-width="0.3"/>
            </svg>
        </div>
        <div class="aia-hero-orb aia-orb-1"></div>
        <div class="aia-hero-orb aia-orb-2"></div>
    </div>
    <div class="aia-hero-inner">
        <div class="aia-hero-label" id="aia-label">Agents IA — HWM Intelligence Artificielle</div>
        <h1 class="aia-hero-h1" id="aia-h1">
            <span class="aia-word">Automatisez</span><br>
            <em><span class="aia-word">votre business</span></em><br>
            <span class="aia-word">avec nos agents</span>
        </h1>
        <p class="aia-hero-sub" id="aia-sub">
            23 agents IA prêts à déployer pour transformer votre relation client,
            votre marketing et vos opérations en moins de 72h.
        </p>
        <div class="aia-hero-ctas" id="aia-ctas">
            ...
            <a href="#aia-listing" class="sb sb-compact sb-invert" role="button">
                <div class="sb-label"><span class="sb-hint">Voir les agents</span></div>
                <div class="sb-knob"><i class="fal fa-arrow-down"></i></div>
            </a>
        </div>
        <div class="aia-count-strip" id="aia-counts">
            <div class="aia-count-item">
                <div class="aia-count-num" data-target="23">0</div>
                <div class="aia-count-txt">Agents disponibles</div>
            </div>
            <div class="aia-count-item">
                <div class="aia-count-num" data-target="7">0</div>
                <div class="aia-count-txt">Domaines couverts</div>
            </div>
            <div class="aia-count-item">
                <div class="aia-count-num" data-target="72">0</div>
                <div class="aia-count-txt">Heures de déploiement</div>
            </div>
        </div>
    </div>
</section>
