...
<div class="cs-page_heading cs-style1 cs-center text-center cs-bg" data-src="<?= $siteURL ?>images/fire.jpeg">
  <div class="container">
    <div class="cs-page_heading_in">
      <h1 class="cs-page_title cs-font_50 cs-white_color heading-title-header mb-0"><?= $page->getTitre() ?></h1>
    </div>
  </div>
</div>
<!-- End Hero -->
  ...
  <div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb text-uppercase">
        ...
        <li class="breadcrumb-item active heading-title-header"><?= $page->getTitre() ?></li>
      </ol>
    </nav>
  </div>
</section>
