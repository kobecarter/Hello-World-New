  ...
  <div class="container">
    <div class="wm-hero-inner">
      <div>
        ...
        <h1 class="sh-h1 rv"><?php echo $lang['AGENCE_RABAT_H1'][$_SESSION['lang']]; ?></h1>
  ...
  <div class="container">
    <div class="sh-context-inner">
      ...
      <div>
        ...
        <h2 class="sh-ctx-title rv"><?php echo $lang['AGENCE_RABAT_CTXTITLE'][$_SESSION['lang']]; ?></h2>
...
<section class="why-agence page-template">
        ...
        <div class="row">
            <div class="col-sm-12">
              <h2 class="sec-label rv"><?php echo $lang['AGENCE_RABAT_POURQUOI'][$_SESSION['lang']]; ?></h2>
              <p class="why-agence-p mb-4"><?php echo $lang['AGENCE_RABAT_INTRO'][$_SESSION['lang']]; ?></p>
            </div>
          </div>
          <div class="row">
          ...
          <p>
              <?php echo $lang['AGENCE_RABAT_EXPERTISE'][$_SESSION['lang']]; ?>
          </p>
          </div>
          </div>
          ...
          <p>
              <?php echo $lang['AGENCE_RABAT_STRATEGIES'][$_SESSION['lang']]; ?>
          </p>
          </div>
          </div>
