  ...
  <div class="container">
    <div class="wm-hero-inner">
      <div>
        ...
        <h1 class="sh-h1 rv"><?php echo $lang['AGENCE_TANGER_H1'][$_SESSION['lang']]; ?></h1>
  ...
  <div class="container">
    <div class="sh-context-inner">
      ...
      <div>
        ...
        <h2 class="sh-ctx-title rv"><?php echo $lang['AGENCE_TANGER_CTXTITLE'][$_SESSION['lang']]; ?></h2>
...
<section class="why-agence page-template">
        ...
        <div class="row">
            <div class="col-sm-12">
              <h2 class="sec-title rv d1"><?php echo $lang['AGENCE_TANGER_POURQUOI'][$_SESSION['lang']]; ?></h2>
             <p class="why-agence-p mb-4"><?php echo $lang['AGENCE_TANGER_INTRO'][$_SESSION['lang']]; ?></p>
            </div>
          </div>
          <div class="row">
          ...
          <p>
<p><?php echo $lang['AGENCE_TANGER_EXPERTISE'][$_SESSION['lang']]; ?></p>
          </p>
          </div>
          </div>
          ...
          <p>
<p><?php echo $lang['AGENCE_TANGER_STRATEGIES'][$_SESSION['lang']]; ?></p>
          </p>
          </div>
          </div>
