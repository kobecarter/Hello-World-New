...
<div class="main-content">
    ...
    <div class="widget widget-blue">
        <div class="widget-title">
            ...
            <h3><i class="icon-table"></i> Liste des articles</h3>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover datatable">
                    <caption style="text-align: left; margin-left: 7px; margin-top: 20px;">
                        ...
                        <?php if($_SESSION['user']->hasDroit('edit', 'com_blog')){ ?>
                        ...
                        <?php if($_SESSION['user']->hasDroit('delete', 'com_blog')){ ?>
                    ...
                    <?php foreach ($posts as $post): ?>
                        <tr id="row_<?= $post->getId(); ?>">
                            ...
                            <td class="text-center">
                                <?php if ($post->isActive() && $_SESSION['user']->hasDroit('edit', 'com_blog')) { ?>
                                    <a href="javascript:void(0)" id="enable_<?= $post->getId(); ?>_oui"
                                ...
                                <?php } else if (!$post->isActive() && $_SESSION['user']->hasDroit('edit', 'com_blog')) { ?>
                                    <a href="javascript:void(0)" id="enable_<?= $post->getId(); ?>_non"
                                ...
                                <?php } ?>
                                <?php if ($_SESSION['user']->hasDroit('edit', 'com_blog')) { ?>
                                    <a href="index.php?option=com_blog&task=edit&id=<?= $post->getId(); ?>"
                                ...
                                <?php } ?>
                                <?php if ($_SESSION['user']->hasDroit('delete', 'com_blog')) { ?>
                                    <a href="javascript:void(0)" id="delete_<?= $post->getId(); ?>"
