<div class="sub-sidebar-wrapper">
    <ul>
        <?php if ($_SESSION['user']->hasDroit('add', 'com_pack')) { ?>
            <li><a href="index.php?option=com_pack&task=add"> Modifier pack</a></li>
        <?php } ?>
...
<div class="main-content">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="index.php?option=com_pack">Packs</a></li>
        <li class="active">Modifier pack</li>
    </ol>
        ...
        <div class="col-md-12">
            ...
            <div class="widget widget-green">
                <div class="widget-title">
                    ...
                    <h3><i class="icon-edit-sign"></i> Modifier pack</h3>
                </div>
