<div class="sub-sidebar-wrapper">
    <ul>
        <?php if ($_SESSION['user']->hasDroit('add', 'com_temoignage')) { ?>
            <li><a href="index.php?option=com_temoignage&task=add"> Ajouter temoignage</a></li>
        <?php } ?>
        <?php if ($_SESSION['user']->hasDroit('view', 'com_temoignage')) { ?>
            <li><a href="index.php?option=com_temoignage"> Liste des temoignages</a></li>
        <?php } ?>
    </ul>
</div>
...
<div class="main-content">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Liste des temoignages</li>
    </ol>
    ...
    <div class="widget widget-blue">
        <div class="widget-title">
            ...
            <h3><i class="icon-table"></i> Liste des temoignages</h3>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover datatable">
                    ...
                    <tr>
                        ...
                        <th>
                            <?php
                                if(isset($trad_com_temoignage['ACTION'][$_SESSION['user']->getLangue()]))
                                    echo $trad_com_temoignage['ACTION'][$_SESSION['user']->getLangue()];
                                else
                                    echo "Action";
                            ?>
                        </th>
                    ...
                    <?php foreach ($temoignages as $temoignage): ?>
                        <tr id="row_<?= $temoignage->getId(); ?>">
                            ...
                            <td class="text-center">
                                <?php if ($temoignage->isActive() && $_SESSION['user']->hasDroit('edit', 'com_temoignage')) { ?>
                                    <a href="javascript:void(0)" id="enable_<?= $temoignage->getId(); ?>_oui"
                                ...
                                <?php } else if (!$temoignage->isActive() && $_SESSION['user']->hasDroit('edit', 'com_temoignage')) { ?>
                                    <a href="javascript:void(0)" id="enable_<?= $temoignage->getId(); ?>_non"
                                ...
                                <?php } ?>
                                <?php if ($_SESSION['user']->hasDroit('edit', 'com_temoignage')) { ?>
                                    <a href="index.php?option=com_temoignage&task=edit&id=<?= $temoignage->getId(); ?>"
                                ...
                                <?php } ?>
                                <?php if ($_SESSION['user']->hasDroit('delete', 'com_temoignage')) { ?>
                                    <a href="javascript:void(0)" id="delete_<?= $temoignage->getId(); ?>"
...
<script type="text/javascript">
    $(function () {
        ...
        $(".delete").click(function () {
            if (confirm("Voulez vous supprimer cet temoignage ?")) {
                var btn = $(this);
                    ...
                    $.post(
                        ...
                        function(theResponse)
                        {
                            if(parseInt(theResponse) == 1){
                                ...
                                $('.msgbox').html('<div class="alert alert-success alert-dismissable"><i class="icon-check-sign"></i> <strong>Succès</strong> les temoignages est activ&eacute;s avec succ&egrave;s</div>');	
                                $('.msgbox').slideDown();
