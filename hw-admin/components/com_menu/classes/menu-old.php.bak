...
<div class="mega glass-mega glass-nav" data-panel="brand">
    ...
    <div class="mega-inner">
                ...
                <div class="vactions">
                    ...
                    <a class="v-pill v-expert"
                       href="'.$contactPage->getLink().'">
                        ðŸ“ž Parler Ã  un expert <b data-vservice></b>
                    </a>
        ...
        $menuHTML .= '
          ...
          <p class="packs-title">DÃ©couvrez nos packs</p>
          <div class="packs-grid" id="packsGrid1">
            ...
            <div class="mega-foot stag" style="--i:11">
                ...
                <div class="foot-row">
                    ...
                    <div class="stars" aria-label="Note 5 sur 5">â˜…â˜…â˜…â˜…â˜…</div>
                    </div>
...
$menuHTML .= '
    <div class="mega glass-mega glass-nav" data-panel="web">
        <div class="mega-inner">
          <div class="visual stag" style="--i:0" data-def-service="Web &amp; Mobile" data-def-desc="Des expÃ©riences digitales rapides, Ã©lÃ©gantes et Ã©volutives." data-def-ico="globe" data-def-grad="grad-web" data-def-img="' . $siteURL . 'images/services/' . $webMobile->getPhoto() . '" data-def-quote="'.htmlspecialchars(strip_tags($testimonial->getTemoignage()), ENT_QUOTES, 'UTF-8').'" data-def-author="'.$testimonial->getNom().'" data-def-role="'.$testimonial->getFonction().'" data-def-cat="nos services Web &amp; Mobile">
            ...
            <div class="cap"><span class="badge">Sur mesure</span><h4 data-vtitle></h4><p data-vdesc></p>
              <div class="vactions"><a class="v-pill v-disc" href="' . $realisationPage->getLink() . '">Voir nos rÃ©alisations â†’</a><a class="v-pill v-expert" href="' . $contactPage->getLink() . '">ðŸ“ž Parler Ã  un expert <b data-vservice></b></a></div></div>
          </div>
          <div class="mega-content">
            <div class="cols-3">';
            ...
            foreach($webMobileChild as $k => $service){
                ...
                elseif($service == 38){
                    $dateDesc = '<li>Sites vitrines & corporate</li> <li>DÃ©veloppement e-commerce</li> <li>Applications web sur mesure</li><li>IntÃ©grations CRM/ERP/API</li>'; 
                }
                elseif($service == 40){
                    $dateDesc = '<li>Audit SEO technique complet</li> <li>Optimisation Core Web Vitals</li> <li>StratÃ©gie de mots-clÃ©s ciblÃ©s</li><li>Optimisation SEO On-Page</li>'; 
                }
                else{
                    $dateDesc = '<li>Espaces clients RGPD</li><li>Dashboards temps rÃ©el</li><li>IntÃ©grations CRM/ERP/API</li>'; 
                }
                $packs = pack::findAll($_SESSION["lang"], true, true, $service->getId());
      ...
      <div class="mega glass-mega glass-nav" data-panel="saas">
        <div class="mega-inner">
          <div class="visual stag" style="--i:0"
               data-def-service="SaaS &amp; Produits" data-def-desc="Du MVP au dashboard dÃ©cisionnel, livrÃ© vite et bien." data-def-ico="rocket" data-def-grad="grad-saas"
               data-def-img="'.$siteURL.'images/pages/saas.webp" data-def-quote="On a lancÃ© notre produit bien plus vite que prÃ©vu." data-def-author="" data-def-role="CEO, HelloWorld" data-def-cat="nos produits SaaS">
          ...
          <div class="mega-content"><div class="cols-3">
            <a class="card stag d-none" style="--i:1" href="' . $saasProduit->getLink() . '" data-service="MVP SaaS" data-desc="Du concept au produit en ligne, vite et bien." data-ico="rocket" data-grad="grad-saas" data-img="https://loremflickr.com/600/700/startup,team?lock=17" data-quote="MVP en ligne en 6 semaines, pile pour notre levÃ©e." data-author="" data-role="">
              ...
              <h3 class="card-title">MVP SaaS</h3><ul class="feat"><li>â€¢ Prototypage rapide</li><li>â€¢ Sprints agiles</li><li>â€¢ ItÃ©ration continue</li></ul></a>
            <a class="card stag" style="--i:2" href="' . $saasProduit->getLink() . '" data-service="MVP SaaS" data-desc="MVP SaaS" data-desc="Du concept au produit en ligne, vite et bien." data-ico="building" data-grad="grad-saas" data-img="https://loremflickr.com/600/700/software,office?lock=18" data-quote="MVP en ligne en 6 semaines, pile pour notre levÃ©e." data-author="" data-role="">
              ...
              <h3 class="card-title">MVP SaaS</h3><ul class="feat"><li>â€¢ Prototypage rapide</li><li>â€¢ Sprints agiles</li><li>â€¢ ItÃ©ration continue</li></ul></a>
            <a class="card stag" style="--i:3" href="' . $saasProduit->getLink() . '" data-service="Plateformes MÃ©tiers" data-desc="Des outils internes qui font gagner du temps." data-ico="building" data-grad="grad-saas" data-img="https://loremflickr.com/600/700/software,office?lock=18" data-quote="Nos process internes ont Ã©tÃ© divisÃ©s par deux." data-author="" data-role="">
              ...
              <h3 class="card-title">Plateformes MÃ©tiers</h3><ul class="feat"><li>â€¢ Outils PME / ETI</li><li>â€¢ Workflows automatisÃ©s</li><li>â€¢ ERP / CRM internes</li></ul></a>
            <a class="card stag" style="--i:4" href="' . $saasProduit->getLink() . '" data-service="Dashboards &amp; Analytics" data-desc="Vos dÃ©cisions enfin guidÃ©es par la donnÃ©e." data-ico="dash" data-grad="grad-saas" data-img="https://loremflickr.com/600/700/data,dashboard?lock=19" data-quote="Les dÃ©cisions se prennent enfin sur de la data fiable." data-author="" data-role="">
              ...
              <h3 class="card-title">Dashboards &amp; Analytics</h3><ul class="feat"><li>â€¢ BI &amp; KPI visuels</li><li>â€¢ Tableaux temps rÃ©el</li><li>â€¢ Reporting automatisÃ©</li></ul></a>
          </div></div>
        </div>
        <div class="mega-foot stag" style="--i:5"><p class="foot-title" data-foottitle></p><div class="foot-row">
        <div class="rating">
      ...
      <div class="mega glass-mega glass-nav" data-panel="market">
        <div class="mega-inner">
          <div class="visual stag" style="--i:0"
               ...
               data-def-img="'.$siteURL.'images/pages/market-place.webp" data-def-quote="Un agent dÃ©ployÃ© en quelques jours, adoptÃ© immÃ©diatement." data-def-author="Lina O." data-def-role="" data-def-cat="nos agents de la Marketplace">
            ...
            <div class="cap"><span class="badge">6 agents</span><h4 data-vtitle></h4><p data-vdesc></p>
              <div class="vactions"><a class="v-pill v-disc" href="' . $marketplace->getLink() . '">Parcourir â†’</a><a class="v-pill v-expert" href="' . $contactPage->getLink() . '">ðŸ“ž Parler Ã  un expert <b data-vservice></b></a></div></div>
          </div>
          <div class="mega-content">
            <p class="eyebrow dark stag" style="--i:1">Marketplace Â· Agents prÃªts Ã  l\'emploi</p>
            <div class="cols-2">
              <a class="sublink stag d-none" style="--i:2" href="' . $marketplace->getLink() . '" data-service="HW Concierge AI" data-desc="Assistant conversationnel multicanal — site, chat, email — formé sur votre catalogue et vos processus. Disponible 24/7, multilingue." data-ico="chat" data-grad="grad-mk" data-img="'.$siteURL.'images/agent-ia/BOARDY.webp" data-quote="DÃ©ployÃ© en 4 jours, adoptÃ© immÃ©diatement par l\'Ã©quipe." data-author="H. Kennou" data-role=""><span class="thumb grad-mk" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/BOARDY.webp" alt="VERDE Agent IA" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">HW Concierge AI</span><span class="desc">Multilingue (FR/AR/EN)</span></span></a>
              <a class="sublink stag" style="--i:2" href="' . $marketplace->getLink() . '" data-service="HW Concierge AI" data-desc="Assistant conversationnel multicanal site, chat, email, formÃ© sur votre catalogue et vos processus. Disponible 24/7, multilingue." data-ico="chat" data-grad="grad-mk" data-img="'.$siteURL.'images/agent-ia/BOARDY.webp" data-quote="DÃ©ployÃ© en 4 jours, adoptÃ© immÃ©diatement par l\'Ã©quipe." data-author="H. Kennou" data-role=""><span class="thumb grad-mk" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/BOARDY.webp" alt="VERDE Agent IA" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">HW Concierge AI</span><span class="desc">Multilingue (FR/AR/EN)</span></span></a>
              <a class="sublink stag" style="--i:3" href="' . $marketplace->getLink() . '" data-service="HW WhatsApp Agent" data-desc="WhatsApp Business automatisÃ© et connectÃ© au CRM." data-ico="whatsapp" data-grad="grad-mk" data-img="'.$siteURL.'images/agent-ia/ASTRO.webp" data-quote="Le SAV WhatsApp tourne en autonomie totale." data-author="" data-role=""><span class="thumb grad-mk" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/ASTRO.webp" alt="ASTRO Agent IA" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">HW WhatsApp Agent</span><span class="desc">WhatsApp Business + CRM</span></span></a>
              <a class="sublink stag" style="--i:4" href="' . $marketplace->getLink() . '" data-service="HW SDR Agent" data-desc="Prospection commerciale et qualification automatisÃ©es." data-ico="target" data-grad="grad-mk" data-img="'.$siteURL.'images/agent-ia/TITAN.webp" data-quote="Notre pipeline n\'a jamais Ã©tÃ© aussi rempli." data-author="" data-role=""><span class="thumb grad-mk" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/TITAN.webp" alt="TITAN Agent IA" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">HW SDR Agent</span><span class="desc">Prospection + qualification</span></span></a>
              <a class="sublink stag" style="--i:5" href="' . $marketplace->getLink() . '" data-service="HW Support 24/7" data-desc="Support multicanal intelligent avec escalade humaine." data-ico="headset" data-grad="grad-mk" data-img="'.$siteURL.'images/agent-ia/SOLA.webp" data-quote="RÃ©ponses instantanÃ©es, clients vraiment ravis." data-author="" data-role=""><span class="thumb grad-mk" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/SOLA.webp" alt="SOLA Agent IA" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">HW Support 24/7</span><span class="desc">Multicanal avec escalade</span></span></a>
              <a class="sublink stag" style="--i:6" href="' . $marketplace->getLink() . '" data-service="HW Content Studio AI" data-desc="GÃ©nÃ©ration de contenu SEO et publication automatique." data-ico="pen" data-grad="grad-mk" data-img="'.$siteURL.'images/agent-ia/PULSE.webp" data-quote="20 articles SEO par mois, sans mÃªme y penser." data-author="" data-role=""><span class="thumb grad-mk" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/PULSE.webp" alt="Pulse Agent IA" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">HW Content Studio AI</span><span class="desc">SEO + publication auto</span></span></a>
              <a class="sublink stag" style="--i:7" href="' . $marketplace->getLink() . '" data-service="HW Voice Caller" data-desc="Agent vocal pour vos appels sortants automatisÃ©s." data-ico="phone" data-grad="grad-mk" data-img="'.$siteURL.'images/agent-ia/VOX.webp" data-quote="Les relances tÃ©lÃ©phoniques sont totalement automatisÃ©es." data-author="" data-role=""><span class="thumb grad-mk" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/VOX.webp" alt="VOX Agent IA" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">HW Voice Caller</span><span class="desc">Appels sortants</span></span></a>
              <a class="sublink stag" style="--i:8" href="' . $marketplace->getLink() . '" data-service="Conversationnel IA" data-desc="Assistants intelligents pour vos sites web et applications." data-ico="chat" data-grad="grad-mk" data-img="'.$siteURL.'images/agent-ia/VERDE2.webp" data-quote="DÃ©ployÃ© en 4 jours, adoptÃ© immÃ©diatement par l\'Ã©quipe." data-author="H. Kennou" data-role=""><span class="thumb grad-mk" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/VERDE2.webp" alt="VERDE Agent IA" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">Conversationnel IA</span><span class="desc">Sites web et apps</span></span></a>
      ...
      <div class="mega glass-mega glass-nav" data-panel="form">
        <div class="mega-inner">
          <div class="visual stag" style="--i:0"
               data-def-service="Formations IA" data-def-desc="Montez en compÃ©tence, vous et vos Ã©quipes." data-def-ico="cap" data-def-grad="grad-form"
               data-def-img="'.$siteURL.'images/pages/formation.webp" data-def-quote="Une montÃ©e en compÃ©tence IA visible dÃ¨s la premiÃ¨re semaine." data-def-author="Patrick D." data-def-cat="nos Formations IA">
            ...
            <div class="cap"><span class="badge">AcadÃ©mie</span><h4 data-vtitle></h4><p data-vdesc></p>
              <div class="vactions"><a class="v-pill v-disc" href="' . $formationIa->getLink() . '">Voir le calendrier â†’</a><a class="v-pill v-expert" href="' . $contactPage->getLink() . '">ðŸ“ž Parler Ã  un expert <b data-vservice></b></a></div></div>
          </div>
          <div class="mega-content">
            <a class="sublink stag" style="--i:1" href="' . $formationIa->getLink() . '" data-service="Master Class Dirigeants IA" data-desc="StratÃ©gie IA pour dÃ©cideurs et C-level â€” 1 jour." data-ico="cap" data-grad="grad-form" data-img="https://loremflickr.com/600/700/conference,executive?lock=27" data-quote="Mon comitÃ© de direction a enfin une vision IA claire." data-author="Patrick D." data-role="CEO, Groupe MÃ©ridien"><span class="thumb grad-form" data-thumb><img loading="lazy" src="https://loremflickr.com/96/96/conference,executive?lock=27" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">Master Class Dirigeants IA <em>(1 jour)</em></span><span class="desc">StratÃ©gie pour dÃ©cideurs et C-level</span></span></a>
            <a class="sublink stag" style="--i:2" href="' . $formationIa->getLink() . '" data-service="Master Class Dirigeants" data-desc="CEO, DG, Directeurs & C-Level." data-ico="gear" data-grad="grad-form" data-img="https://loremflickr.com/600/700/coding,workshop?lock=28" data-quote="Mon Ã©quipe automatise dÃ©jÃ  ses tÃ¢ches rÃ©pÃ©titives."><span class="thumb grad-form" data-thumb><img loading="lazy" src="https://loremflickr.com/96/96/coding,workshop?lock=28" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">Master Class Dirigeants <em>(1 journÃ©e)</em></span><span class="desc">CEO, DG, Directeurs & C-Level</span></span></a>
            <a class="sublink stag" style="--i:3" href="' . $formationIa->getLink() . '" data-service="Bootcamp No-Code IA" data-desc="Ã©quipes opÃ©rationnelles, chefs de projet" data-ico="press" data-grad="grad-form" data-img="https://loremflickr.com/600/700/marketing,team?lock=29" data-quote="Nos campagnes sont passÃ©es Ã  la vitesse supÃ©rieure." ><span class="thumb grad-form" data-thumb><img loading="lazy" src="https://loremflickr.com/96/96/marketing,team?lock=29" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">Bootcamp No-Code IA <em>(3 jours)</em></span><span class="desc">Equipes opÃ©rationnelles, chefs de projet</span></span></a>
            <a class="sublink stag" style="--i:4" href="' . $formationIa->getLink() . '" data-service="Formation IA Marketing" data-desc="Ã©quipes marketing, content, social media" data-ico="share" data-grad="grad-form" data-img="https://loremflickr.com/600/700/workshop,whiteboard?lock=30" data-quote="On a conÃ§u notre premier agent en une seule journÃ©e."><span class="thumb grad-form" data-thumb><img loading="lazy" src="https://loremflickr.com/96/96/workshop,whiteboard?lock=30" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">Formation IA Marketing <em>(2 jours)</em></span><span class="desc">Equipes marketing, content, social media</span></span></a>
            <a class="sublink stag" style="--i:5" href="' . $formationIa->getLink() . '" data-service="Atelier Agents IA" data-desc="DÃ©veloppeurs, architectes, tech leads" data-ico="star" data-grad="grad-form" data-img="https://loremflickr.com/600/700/meeting,consulting?lock=31" data-quote="Un programme taillÃ© pile pour nos enjeux internes."><span class="thumb grad-form" data-thumb><img loading="lazy" src="https://loremflickr.com/96/96/meeting,consulting?lock=31" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">Atelier Agents IA <em>(2 jours)</em></span><span class="desc">DÃ©veloppeurs, architectes, tech leads</span></span></a>
      ...
      <div class="mega glass-mega glass-nav" data-panel="solutions">
        <div class="mega-inner">
          <div class="visual stag" style="--i:0"
               ...
               data-def-quote="Hello World a transformÃ© notre relation client en quelques semaines." data-def-author="" data-def-role="" data-def-cat="nos Solutions IA">
            ...
            <div class="cap"><span class="badge">Service IA</span><h4 data-vtitle>Solutions IA</h4><p data-vdesc></p>
              <div class="vactions"><a class="v-pill v-disc" href="' . $solutionIA->getLink() .'">DÃ©couvrir â†’</a><a class="v-pill v-expert" href="' . $contactPage->getLink() .'">ðŸ“ž Parler Ã  un expert <b data-vservice></b></a></div></div>
          </div>
          <div class="mega-content">
            <div class="cols-3">
              <div class="stag" style="--i:1"><p class="eyebrow dark">Agents IA</p>
                <a class="sublink" href="' . $solutionIA->getLink() .'" data-service="Conversationnel IA" data-desc="Assistants intelligents pour vos sites web et applications." data-ico="chat" data-grad="grad-sol" data-img="'.$siteURL.'images/agent-ia/VERDE2.webp" data-quote="Notre taux de rÃ©ponse a doublÃ© en deux semaines." data-author="" data-role=""><span class="thumb grad-sol" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/VERDE2.webp" alt="VERDE Agent IA" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">Conversationnel IA</span><span class="desc">Sites web et apps</span></span></a>
                
                <a class="sublink" href="' . $solutionIA->getLink() .'" data-service="Concierge AI" data-desc="Assistance virtuelle sur-mesure — guide vos clients 24/7" data-ico="whatsapp" data-grad="grad-sol" data-img="'.$siteURL.'images/agent-ia/BOARDY.webp" data-quote="Les clients adorent rÃ©pondre sur WhatsApp, et nous aussi." data-author="" data-role=""><span class="thumb grad-sol" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/BOARDY.webp" alt="BOARDY Agent IA" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">Concierge AI</span><span class="desc">Assistance virtuelle sur-mesure &amp; guide vos clients 24/7</span></span></a>
                <a class="sublink" href="' . $solutionIA->getLink() .'" data-service="Voice Caller" data-desc="Des assistants vocaux qui dÃ©crochent Ã  votre place." data-ico="mic" data-grad="grad-sol" data-img="'.$siteURL.'images/agent-ia/VOX.webp" data-quote="L\'agent vocal gÃ¨re 70% de nos appels entrants." data-author="" data-role=""><span class="thumb grad-sol" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/VOX.webp" alt="VOX Agent IA" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">Voice Caller</span><span class="desc">Appels entrants/sortants automatisÃ©s</span></span></a>
                <a class="sublink" href="' . $solutionIA->getLink() .'" data-service="Support 24/7" data-desc="Un service client automatisÃ© qui ne dort jamais." data-ico="headset" data-grad="grad-sol" data-img="'.$siteURL.'images/agent-ia/SOLA.webp" data-quote="Plus aucun ticket en attente le matin." data-author="" data-role=""><span class="thumb grad-sol" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/SOLA.webp" alt="SOLA Agent IA" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">Support 24/7</span><span class="desc">Service automatisÃ©</span></span></a>
                ...
                <a class="sublink" href="' . $solutionIA->getLink() .'" data-service="HW Content Studio" data-desc="Contenu marketing intelligent" data-ico="headset" data-grad="grad-sol" data-img="'.$siteURL.'images/agent-ia/PULSE.webp" data-quote="Contenu IA fidèle à votre marque" data-author="" data-role=""><span class="thumb grad-sol" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/PULSE.webp" alt="PULSE Agent IA" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">HW Content Studio</span><span class="desc">Contenu marketing intelligent</span></span></a>
              
              </div>
              <div class="divider stag" style="--i:2"><p class="eyebrow dark">Automatisations</p>
                <a class="sublink" href="' . $solutionIA->getLink() .'" data-service="CRM" data-desc="Vos leads synchronisÃ©s et vos clients suivis, sans friction." data-ico="users" data-grad="grad-sol" data-img="'.$siteURL.'images/agent-ia/CRM.webp" data-quote="Nos leads sont enfin synchronisÃ©s partout." data-author="" data-role=""><span class="thumb grad-sol" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/CRM.webp" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">CRM</span><span class="desc">Leads &amp; clients</span></span></a>
                <a class="sublink" href="' . $solutionIA->getLink() .'" data-service="Email" data-desc="Des campagnes ciblÃ©es et des relances automatiques." data-ico="mail" data-grad="grad-sol" data-img="'.$siteURL.'images/agent-ia/Email.webp" data-quote="Nos campagnes tournent toutes seules dÃ©sormais." data-author="" data-role=""><span class="thumb grad-sol" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/Email.webp" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">Email</span><span class="desc">Campagnes &amp; suivis</span></span></a>
                <a class="sublink" href="' . $solutionIA->getLink() .'" data-service="Prospection" data-desc="Des prospects qualifiÃ©s engagÃ©s automatiquement." data-ico="target" data-grad="grad-sol" data-img="'.$siteURL.'images/agent-ia/Prospection.webp" data-quote="On signe deux fois plus de RDV qualifiÃ©s." data-author="" data-role=""><span class="thumb grad-sol" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/Prospection.webp" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">Prospection</span><span class="desc">Leads qualifiÃ©s</span></span></a>
                <a class="sublink" href="' . $solutionIA->getLink() .'" data-service="Reporting" data-desc="Vos performances visibles en un coup d\'Å“il." data-ico="chart" data-grad="grad-sol" data-img="'.$siteURL.'images/agent-ia/Reporting.webp" data-quote="Je vois mes KPIs en un coup d\'Å“il chaque matin." data-author="" data-role=""><span class="thumb grad-sol" data-thumb><img loading="lazy" src="'.$siteURL.'images/agent-ia/Reporting.webp" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">Reporting</span><span class="desc">Tableaux de bord</span></span></a>
              </div>
              <div class="divider stag" style="--i:3"><p class="eyebrow dark">Sectoriel</p>
                <a class="sublink" href="' . $secteurImmo->getLink() .'" data-service="Immobilier" data-desc="Des solutions pensÃ©es pour agences et promoteurs." data-ico="home" data-grad="grad-sol" data-img="'.$siteURL.'images/secteur/'.$secteurImmo->getPhoto().'" data-quote="Nos agences ont gagné un temps fou sur les visites." data-author="Nadia F." data-role="Dir., HomeKey"><span class="thumb grad-sol" data-thumb><img loading="lazy" src="'.$siteURL.'images/secteur/'.$secteurImmo->getPhoto().'" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">Immobilier</span><span class="desc">Agences &amp; promoteurs</span></span></a>
                <a class="sublink" href="' . $secteurHotel->getLink() .'" data-service="Hôtellerie" data-desc="RÃ©servations et services clients pour l\'hÃ´tellerie." data-ico="hotel" data-grad="grad-sol" data-img="'.$siteURL.'images/secteur/'.$secteurHotel->getPhoto().'" data-quote="Les rÃ©servations se gÃ¨rent sans effort, mÃªme la nuit." data-author="" data-role=""><span class="thumb grad-sol" data-thumb><img loading="lazy" src="'.$siteURL.'images/secteur/'.$secteurHotel->getPhoto().'" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">HÃ´tellerie</span><span class="desc">HÃ´tellerie</span></span></a>
                <a class="sublink" href="' . $secteurMarketing->getLink() .'" data-service="Marketing" data-desc="Rapports & distribution de contenus" data-ico="bag" data-grad="grad-sol" data-img="'.$siteURL.'images/secteur/'.$secteurMarketing->getPhoto().'" data-quote="Notre panier moyen a grimpÃ© de 18%." data-author="Clara V." data-role=""><span class="thumb grad-sol" data-thumb><img loading="lazy" src="'.$siteURL.'images/secteur/'.$secteurMarketing->getPhoto().'" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">Marketing</span><span class="desc">Rapports &amp; distribution de contenus</span></span></a>
                <a class="sublink" href="' . $secteurSante->getLink() .'" data-service="SantÃ©" data-desc="Des solutions fiables pour Ã©tablissements mÃ©dicaux." data-ico="heart" data-grad="grad-sol" data-img="'.$siteURL.'images/secteur/'.$secteurSante->getPhoto().'" data-quote="Les prises de rendez-vous patients sont enfin fluides." data-author="" data-role=""><span class="thumb grad-sol" data-thumb><img loading="lazy" src="'.$siteURL.'images/secteur/'.$secteurSante->getPhoto().'" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">SantÃ©</span><span class="desc">optimisez le temps mÃ©dical</span></span></a>
               ...
               <a class="sublink" href="' . $secteurOperation->getLink() .'" data-service="OpÃ©rations" data-desc="Assistez vos Ã©quipes au quotidien" data-ico="heart" data-grad="grad-sol" data-img="'.$siteURL.'images/secteur/'.$secteurOperation->getPhoto().'" data-quote="Assistez vos Ã©quipes au quotidien" data-author="" data-role=""><span class="thumb grad-sol" data-thumb><img loading="lazy" src="'.$siteURL.'images/secteur/'.$secteurOperation->getPhoto().'" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">OpÃ©ration</span><span class="desc">Assistez vos Ã©quipes au quotidien</span></span></a>
      ...
      <div class="mega glass-mega glass-nav" data-panel="agencies">
        <div class="mega-inner">
          <div class="visual stag" style="--i:0"
               data-def-service="Nos Agences" data-def-desc="Une prÃ©sence mondiale, un accompagnement de proximitÃ© et des solutions pensÃ©es pour vos ambitions internationales." data-def-ico="robot" data-def-grad="grad-mk"
               data-def-img="'.$siteURL.'images/pages/'.$agenceMarra->getPhoto().'" data-def-quote="Un agent dÃ©ployÃ© en quelques jours, adoptÃ© immÃ©diatement." data-def-author="Lina O." data-def-role="" data-def-cat="Notre prÃ©sence internationale">
            <a class="vimg-link" href="#"><span class="vimg-wrap grad-mk" data-vgrad><span class="vico" data-vico></span><img class="vimg" data-vimg alt=""></span></a>
            <div class="cap"><span class="badge">6 agents</span><h4 data-vtitle></h4><p data-vdesc></p>
              <div class="vactions"><a class="v-pill v-disc" href="' . $nosAgence->getLink() . '">Parcourir â†’</a><a class="v-pill v-expert" href="' . $contactPage->getLink() . '">ðŸ“ž Parler Ã  un expert <b data-vservice></b></a></div></div>
          </div>
          <div class="mega-content">
            <p class="eyebrow dark stag" style="--i:1">Nos Agences</p>
            <div class="cols-2">
            
            <a class="sublink stag" style="--i:2" href="' . $agenceCasa->getLink() . '" data-service="' . $agenceCasa->getTitre() . '" data-desc="'.htmlspecialchars(strip_tags($agenceMarra->getExtrait()), ENT_QUOTES, 'UTF-8').'" data-ico="chat" data-grad="grad-mk" data-img="'.$siteURL.'images/pages/'.$agenceCasa->getPhoto().'" data-quote="DÃ©ployÃ© en 4 jours, adoptÃ© immÃ©diatement par l\'Ã©quipe." data-author="H. Kennou" data-role=""><span class="thumb grad-mk" data-thumb><img loading="lazy" src="'.$siteURL.'images/pages/'.$agenceCasa->getPhoto().'" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">'.$agenceCasa->getTitre().'</span></span></a>
            <a class="sublink stag" style="--i:3" href="' . $agenceMarra->getLink() . '" data-service="' . $agenceMarra->getTitre() . '" data-desc="'.htmlspecialchars(strip_tags($agenceMarra->getExtrait()), ENT_QUOTES, 'UTF-8').'" data-ico="chat" data-grad="grad-mk" data-img="'.$siteURL.'images/pages/'.$agenceMarra->getPhoto().'" data-quote="DÃ©ployÃ© en 4 jours, adoptÃ© immÃ©diatement par l\'Ã©quipe." data-author="H. Kennou" data-role=""><span class="thumb grad-mk" data-thumb><img loading="lazy" src="'.$siteURL.'images/pages/'.$agenceMarra->getPhoto().'" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">'.$agenceMarra->getTitre().'</span></span></a>
            <a class="sublink stag" style="--i:4" href="' . $agenceLondre->getLink() . '" data-service="' . $agenceLondre->getTitre() . '" data-desc="'.htmlspecialchars(strip_tags($agenceLondre->getExtrait()), ENT_QUOTES, 'UTF-8').'" data-ico="chat" data-grad="grad-mk" data-img="'.$siteURL.'images/pages/'.$agenceLondre->getPhoto().'" data-quote="DÃ©ployÃ© en 4 jours, adoptÃ© immÃ©diatement par l\'Ã©quipe." data-author="H. Kennou" data-role=""><span class="thumb grad-mk" data-thumb><img loading="lazy" src="'.$siteURL.'images/pages/'.$agenceLondre->getPhoto().'" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">'.$agenceLondre->getTitre().'</span></span></a>
            
          
            <a class="sublink stag" style="--i:5" href="' . $agenceTanger->getLink() . '" data-service="' . $agenceTanger->getTitre() . '" data-desc="'.htmlspecialchars(strip_tags($agenceTanger->getExtrait()), ENT_QUOTES, 'UTF-8').'" data-ico="chat" data-grad="grad-mk" data-img="'.$siteURL.'images/pages/'.$agenceTanger->getPhoto().'" data-quote="DÃ©ployÃ© en 4 jours, adoptÃ© immÃ©diatement par l\'Ã©quipe." data-author="H. Kennou" data-role=""><span class="thumb grad-mk" data-thumb><img loading="lazy" src="'.$siteURL.'images/pages/'.$agenceTanger->getPhoto().'" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">'.$agenceTanger->getTitre().'</span></span></a>
            <a class="sublink stag" style="--i:5" href="' . $agenceRabat->getLink() . '" data-service="' . $agenceRabat->getTitre() . '" data-desc="'.htmlspecialchars(strip_tags($agenceRabat->getExtrait()), ENT_QUOTES, 'UTF-8').'" data-ico="chat" data-grad="grad-mk" data-img="'.$siteURL.'images/pages/'.$agenceRabat->getPhoto().'" data-quote="DÃ©ployÃ© en 4 jours, adoptÃ© immÃ©diatement par l\'Ã©quipe." data-author="H. Kennou" data-role=""><span class="thumb grad-mk" data-thumb><img loading="lazy" src="'.$siteURL.'images/pages/'.$agenceRabat->getPhoto().'" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">'.$agenceRabat->getTitre().'</span></span></a>
            <a class="sublink stag" style="--i:5" href="' . $agenceFes->getLink() . '" data-service="' . $agenceFes->getTitre() . '" data-desc="'.htmlspecialchars(strip_tags($agenceFes->getExtrait()), ENT_QUOTES, 'UTF-8').'" data-ico="chat" data-grad="grad-mk" data-img="'.$siteURL.'images/pages/'.$agenceFes->getPhoto().'" data-quote="DÃ©ployÃ© en 4 jours, adoptÃ© immÃ©diatement par l\'Ã©quipe." data-author="H. Kennou" data-role=""><span class="thumb grad-mk" data-thumb><img loading="lazy" src="'.$siteURL.'images/pages/'.$agenceFes->getPhoto().'" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">'.$agenceFes->getTitre().'</span></span></a>
            <a class="sublink stag" style="--i:5" href="' . $agenceAgadir->getLink() . '" data-service="' . $agenceAgadir->getTitre() . '" data-desc="'.htmlspecialchars(strip_tags($agenceAgadir->getExtrait()), ENT_QUOTES, 'UTF-8').'" data-ico="chat" data-grad="grad-mk" data-img="'.$siteURL.'images/pages/'.$agenceAgadir->getPhoto().'" data-quote="DÃ©ployÃ© en 4 jours, adoptÃ© immÃ©diatement par l\'Ã©quipe." data-author="H. Kennou" data-role=""><span class="thumb grad-mk" data-thumb><img loading="lazy" src="'.$siteURL.'images/pages/'.$agenceAgadir->getPhoto().'" alt="" onerror="this.style.display=\'none\'"><span class="thumb-ico"></span></span><span class="tx"><span class="ttl">'.$agenceAgadir->getTitre().'</span></span></a>
                                ...
                                <ul class="submenu-content__list">';
                                    ...
                                    <li class="submenu-content__list-item">
                                        <a href="'.$s->getLink().'" class="submenu-content__link">
                                            ...
                                            <button class="new-service-readmore" href="'.$s->getLink().'">DÃ©couvrez notre expertise</button>
                                        </a>
                                    </li>';
                                    $menuHTML .= '</ul>';
                                    ...
                                    if (!empty($packs)) {
                                        ...
                                        $menuHTML .= '
                                            <h3 class="pack-titre">DÃ©couvrez nos packs</h3>
                                    ...
                                    <ul class="submenu-content__list">';
                                        ...
                                        <li class="submenu-content__list-item">
                                            <a href="https://www.helloworldlabel.ae/" class="submenu-content__link">
                                                ...
                                                <div class="submenu-content__link-title">
                                                    Agence Marketing Digital Ã  Dubai
                                                </div>
                                                <p>
                                                Hello World Label est une agence de marketing digital Ã  Dubai qui accompagne les PME, startups et grandes entreprises dans le dÃ©veloppement de leur visibilitÃ© en ligne. Nous proposons des stratÃ©gies digitales adaptÃ©es au marchÃ© local afin dâ€™assurer une croissance durable et mesurable.
                                                </p>
                                            </a>
                                        </li>';
