(function($) {
  ...
  $(document).ready(function() {
		  ...
		  responsive: {
			...
			1000: {
			  items: 3
				...
				$("#owl-service-agence").owlCarousel({
			lazyLoad: true,
			  loop: true,
			  nav: true,
			  navText : ["",""],	
	...
	// 	}
	// });
			$('form#realisationPopup').ajaxForm({
					beforeSubmit: function () {
						$("form#realisationPopup .loading").css("display", "block");
					},
					success: function (theResponse) {
						console.log(theResponse);
						$("form#realisationPopup .loading").hide();
						var offset = $("#realisationPopup .msgbox").offset().top - 100;
						$("html, body").animate({ scrollTop: offset }, "slow");
						
						if (parseInt(theResponse) === 1) {
							$('form#realisationPopup .msgbox').html('<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button>'+SUCCES_ENVOI+'</div>');
							$('form#realisationPopup')[0].reset();
							// document.location = REDIRECT_LINK_QUOTE;
						}
						else if (parseInt(theResponse) === 0) {
							$('form#realisationPopup .msgbox').html('<div class="alert alert-warning alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button> '+CHAMPS_OBLIG+' </div>');
						}
						else if (parseInt(theResponse) === 2) {
							$('form#realisationPopup .msgbox').html('<div class="alert alert-warning alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button> Code antispam incorrecte</div>');
						}
						else {
							$('form#realisationPopup .msgbox').html('<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button> '+ERREUR_EXEC+'</div>');
						}
					}
				});
			...
			event.stopPropagation();
					  	...
					  	/* -----------------------------------
							...
							$('form#devisForm').ajaxForm({
								...
								$('form#consultingRendezVous').ajaxForm({
								beforeSubmit: function () {
									// chargement
									$("form#consultingRendezVous .loading").css("display", "block");
								},
								success: function (theResponse) {
									console.log(theResponse)
									$("form#consultingRendezVous .loading").hide();
									var offset = $("#consultingRendezVous .msgbox").offset().top - 100;
									$("html, body").animate({ scrollTop: offset }, "slow");
									
									if (parseInt(theResponse) === 1) {
										$('form#consultingRendezVous .msgbox').html('<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button>'+SUCCES_ENVOI+'</div>');
										$('form#consultingRendezVous')[0].reset();
										location.reload();
									document.location = REDIRECT_LINK_QUOTE;
									}
									else if (parseInt(theResponse) === 0) {
										$('form#consultingRendezVous .msgbox').html('<div class="alert alert-warning alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button> '+CHAMPS_OBLIG+' </div>');
									}
									else if (parseInt(theResponse) === 2) {
										$('form#consultingRendezVous .msgbox').html('<div class="alert alert-warning alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button> Code antispam incorrecte</div>');
									}
									else {
										$('form#consultingRendezVous .msgbox').html('<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert">&times;</button> '+ERREUR_EXEC+'</div>');
									}
								}
							});
							  ...
							  }else if(id =="devisForm"){
								$("form#devisForm").submit()
							  }
							  else if(id =="consultingRendezVous"){
								$("form#consultingRendezVous").submit()
							  }
		  }
