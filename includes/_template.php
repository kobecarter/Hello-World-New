...
.sec-label{font-size:.64rem;letter-spacing:.42em;text-transform:uppercase;color:var(--gold);display:flex;align-items:center;gap:.9rem;margin-bottom:1.2rem}
.sec-label::before{content:'';width:36px;height:1px;background:var(--gold)}
.sec-title{font-family:var(--fm);font-weight:300;font-size:clamp(2.2rem,5vw,5.5rem);line-height:.95;color:var(--txt);letter-spacing:-.03em;margin-bottom:2.5rem}
...
.svc-card{padding:2.8rem 2.4rem;border-right:1px solid var(--border);border-bottom:1px solid var(--border);position:relative;overflow:hidden;transition:background .35s;cursor:default}
...
.svc-desc{font-family:var(--fm);font-size:.78rem;font-weight:300;color:var(--txt2);line-height:1.85;height: 165px;overflow: hidden;display: -webkit-box;-webkit-line-clamp: 7;-webkit-box-orient: vertical;}
.svc-more{display:inline-flex;align-items:center;gap:.45rem;margin-top:1.6rem;font-size:.64rem;font-weight:700;letter-spacing:.22em;text-transform:uppercase;color:var(--gold);opacity:0;transform:translateX(-8px);transition:all .3s}
...
.srv-card{display:flex;flex-direction:column;border-right:1px solid var(--border);overflow:hidden;transition:background .3s}
